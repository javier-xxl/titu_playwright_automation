...
tarjetas: [
{ titulo: 'SFTP', descripcion: 'Protocolo seguro de transferencia de archivos' },
{ titulo: 'SharePoint', descripcion: 'Servicio de integración de Microsoft' },
{ titulo: 'Amazon S3', descripcion: 'Servicio de almacenamiento en la nube' },
{ titulo: 'REST API', descripcion: 'Aplicación de Interfaz de Programación' }
]
},

{
nombre: 'Tipos De Archivos',
subtitulo: 'El sistema tiene permitido los tipos de archivos que se muestran a continuación.',
...
menu: 'Tipos De Datos',
tarjetas: [
{ titulo: 'VARCHAR2', descripcion: 'Cadena de caracteres de longitud variable.' },
{ titulo: 'NUMBER', descripcion: 'Número que puede contener dígitos enteros.' },
{ titulo: 'DATE', descripcion: 'Fecha que incluye día, mes y año.' },
{ titulo: 'TIMESTAMP', descripcion: 'Marca de tiempo que incluye fecha y hora.' },
{ titulo: 'CLOB', descripcion: 'Objeto de gran tamaño para almacenar texto.' },
{ titulo: 'BLOB', descripcion: 'Objeto de gran tamaño para almacenar datos binarios.' }
]
}
